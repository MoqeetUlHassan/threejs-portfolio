...
export const myProjects = [
  ...
  },
  {
    ...
    logo: '/threejs-portfolio/assets/keystone.svg',
    logoStyle: {
      backgroundColor: '#13202F',
      border: '0.2px solid #17293E',
      boxShadow: '0px 0px 60px 0px #2F6DB54D',
    },
    spotlight: '/threejs-portfolio/assets/spotlight2.png',
    tags: [
      {
        id: 1,
        name: 'Django',
        path: '/threejs-portfolio/assets/django.svg',
      },
      {
        id: 2,
        name: 'React.js',
        path: '/threejs-portfolio/assets/react.svg',
      },
      {
        id: 3,
        name: 'PostgreSQL',
        path: '/threejs-portfolio/assets/postgresql.svg',
      },
    ],
  },
  {
    ...
    logo: '/threejs-portfolio/assets/project-logo-mausam.png',
    logoStyle: {
    ...
    spotlight: '/threejs-portfolio/assets/spotlight3.png',
    tags: [
      {
        id: 1,
        name: 'React.js',
      ...
      },
      {
        id: 2,
        name: 'Node.js',
        path: '/threejs-portfolio/assets/nodejs.svg',
      },
      {
        id: 3,
        name: 'OpenWeather API',
        path: '/threejs-portfolio/assets/openweather.svg',
      },
    ],
  },
  {
    ...
    logo: '/threejs-portfolio/assets/project-logo-bovit.png',
    logoStyle: {
      backgroundColor: '#1C1A43',
      border: '0.2px solid #252262',
      boxShadow: '0px 0px 60px 0px #635BFF4D',
    },
    spotlight: '/threejs-portfolio/assets/spotlight4.png',
    tags: [
      {
        id: 1,
        name: 'Next.js',
        path: '/threejs-portfolio/assets/nextjs.svg',
      },
      {
        id: 2,
        name: 'Stripe',
        path: '/threejs-portfolio/assets/stripe.svg',
      },
      {
        id: 3,
        name: 'Firebase',
        path: '/threejs-portfolio/assets/firebase.svg',
      },
    ],
  },
];
...
export const workExperiences = [
  {
    ...
    icon: '/threejs-portfolio/assets/framer.svg',
    animation: 'victory',
  },
  {
    id: 2,
    ...
    icon: '/threejs-portfolio/assets/figma.svg',
    animation: 'clapping',
  },
  {
    id: 3,
    ...
    icon: '/threejs-portfolio/assets/notion.svg',
    animation: 'salute',
  },
];
