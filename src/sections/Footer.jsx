    ...
    <footer className="c-space pt-7 pb-3 border-t border-black-300 flex justify-between items-center flex-wrap gap-5">
      ...
      <div className="flex gap-3">
        <a href="https://github.com/MoqeetUlHassan" className="social-icon">
          <img src="/threejs-portfolio/assets/github.svg" alt="github" className="w-1/2 h-1/2" />
        </a>
        <a href="https://x.com/moqeet1998" className="social-icon">
          <img src="/threejs-portfolio/assets/twitter.svg" alt="twitter" className="w-1/2 h-1/2" />
        </a>
        <a href="https://www.instagram.com/nugatorypoetry/" className="social-icon">
          <img src="/threejs-portfolio/assets/instagram.svg" alt="instagram" className="w-1/2 h-1/2" />
        </a>
        <a href="https://www.linkedin.com/in/moqeet-ul-hassan/" className="social-icon">
          <img src="/threejs-portfolio/assets/linkedin.svg" alt="linkedin" className="w-1/2 h-1/2" />
        </a>
      </div>
